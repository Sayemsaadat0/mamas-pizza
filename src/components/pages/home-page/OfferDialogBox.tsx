            ...
            <div className="max-w-xl mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-h-80 overflow-y-auto pr-1">
                  {visibleMenus?.map((menu) => {
                    ...
                    return (
                      ...
                      >
                        <div className={`rounded-xl border transition-all ${isSelectedForStep ? "border-blue-500 ring-2 ring-blue-200 bg-white" : "border-gray-200 bg-white hover:border-gray-300"}`}>
                          <div className="flex gap-3 p-3">
                            <div className="w-14 h-14 rounded-lg bg-gray-100 flex-shrink-0 overflow-hidden">
                              {menu.thumbnail ? (
                                <Image width={56} height={56} src={`${process.env.NEXT_PUBLIC_API_URL}/${menu.thumbnail}`} alt={menu.name} className="w-full h-full object-cover" />
                              ) : (
                            ...
                            <div className={`w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 ${isSelectedForStep ? "bg-blue-500" : "bg-gray-200"}`}>
              ...
              <div className="mt-4 flex items-center justify-between">
                <Button
                  ...
                  size="sm"
                  onClick={goBackStep}
                  className="bg-white hover:bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 text-xs font-medium text-gray-700"
                >
                  Back
                </Button>
